import type { GuideTocEntry } from "@/site/guides";
...
export const COOKIE_POLICY_TOC: GuideTocEntry[] = [
  ...
  { id: "duree-conservation", title: "Durée de conservation", level: 2 },
  { id: "base-legale", title: "Base légale", level: 2 },
  { id: "vos-droits", title: "Vos droits", level: 2 },
